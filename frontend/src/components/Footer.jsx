      ...
      <div className="text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32 bg-[#f6f9fc]">
        <div className="flex flex-wrap justify-between gap-12 md:gap-6">
          <div className="max-w-80">
            ...
            />
            <p className="text-sm">
              Discover the most extraordinary places to stay, from boutique hotels to luxury villas and private islands</p>
        ...
        <div className="flex flex-col md:flex-row gap-2 items-center justify-between py-5">
          <p>
            ...
            <a href="https://prebuiltui.com">GreateStay</a>. All rights
            reserved.
          </p>
